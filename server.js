...
// Chat Groups — Members management for chat rooms
app.use('/api/chat-groups', require('./routes/chatGroups'));

// Payment Receipts — Received EMI/Down Payment tracking
app.use('/api/payment-receipts', require('./routes/paymentReceipts'));

// Customer Dues — Udhaari / Credit Ledger tracking
app.use('/api/customer-dues', require('./routes/customerDues'));
